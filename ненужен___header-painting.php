		...
		<nav class="navbar navbar-default menu">
			<div class="container shift-menu">
				<div class="navbar-header">
					...
					<a class="navbar-brand mybrand" href="index.php"><img src="img/logo_dblue.png" alt=""></a>
				</div> 

				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav">
						<li class="visible-ld"><a href="index.php">Главная<span class="sr-only">(current)</span></a></li>
						<li class="dropdown">
						...
						<li class="dropdown  active-link">
							...
							<ul class="dropdown-menu">
								...
								<li><a href="iconostas-1.php">г.Холм</a></li>
								<li role="separator" class="divider"></li>
						...
						<li><a href="map-site.php">Карта сайта</a></li>	
					</ul>
				</div><!-- /.navbar-collapse -->
			</div><!-- /.container -->
		</nav>
